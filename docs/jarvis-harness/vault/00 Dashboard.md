...
- Session continuity controls are in progress: `session.list`, `session.get`, HUD session selection, and explicit HUD session creation.
...
1. Validate and commit session continuity controls.
