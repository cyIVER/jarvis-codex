...
- Managed PTY supervision is validated and awaiting commit.
...
1. Commit and push managed PTY supervision.
2. Continue into event streaming and approval lifecycle.
