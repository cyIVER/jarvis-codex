...
- screen-sized multi-page HUD navigation, shell-style state-only operator intent bar, release gate status, release evidence metadata recording, read-only acceptance brief, explicit gate acceptance recording, and release readiness checklist panels
