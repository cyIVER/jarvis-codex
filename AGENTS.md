...
- Before marking the conversion PR ready, run `scripts/verify-pr-readiness.sh`. It checks generated-artifact hygiene, secret-bearing config paths, local tests/build, and current GitHub PR checks without mutating services or pushing.
